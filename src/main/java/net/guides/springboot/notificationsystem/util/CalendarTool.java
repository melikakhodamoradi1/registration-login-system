...
public class CalendarTool {
    ...
    public CalendarTool() {
        ...
        myMinutes = calendar.get(Calendar.MINUTE);
        mySeconds = calendar.get(Calendar.SECOND);
    }
    ...
    public String getIranianDate() {
        return (irYear + "/" + String.format("%02d", irMonth) + "/" + String.format("%02d", irDay));
    }
    ...
    public String getIranianDateTime() {
        return (irYear + "/" + String.format("%02d", irMonth) + "/" + String.format("%02d", irDay) + " " + String.format("%02d", myHour) + ":" + String.format("%02d", myMinutes) + ":" + String.format("%02d", mySeconds));
    }
    ...
    public String getIranianDateTime2(Locale locale) {
        String str = "{0, number,#}" + "-" + "{1, number,#}" + "-" + "{2, number,#}" + " " + "{3, number,#,00}" + ":" + "{4, number,#,00}" + ":" + "{5, number,#,00}";
        MessageFormat formatter = new MessageFormat(str, locale);

        String format = formatter.format(new Object[]{irYear,irMonth,irDay,myHour,myMinutes,mySeconds});
        return format;
    }
    ...
    public String getGregorianDate2WithTime() {
        return (gYear + "-" + String.format("%02d", gMonth) + "-" + String.format("%02d", gDay) + " " + String.format("%02d", myHour) + ":" + String.format("%02d", myMinutes) + ":" + String.format("%02d", mySeconds));
    }
